...
export class saturnModel {
  ...
  createRing() {
    ...
    const innerRadius = this.baseRadius * 1.1; // Start ring at 1.3x planet radius
    const outerRadius = this.baseRadius * 2.3; // End at 2.5x planet radius
